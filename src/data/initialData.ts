...
export const DEFAULT_PRINTERS: StationPrinter[] = [
  {
    id: "usb-pos-58",
    name: "Ticketera USB Laptop (POS-58-Series)",
    station: "Caja & Facturación",
    categories: [],
    connectionType: "usb",
    ipAddress: "POS-58-Series",
    port: 0,
    paperWidth: "58mm",
    status: "online",
    autoPrint: true,
...
export const DEFAULT_SETTINGS_LASLOMAS: Settings = {
  ...
  address: "Jr, Templo del Sol 589 urb, San Juan de Lurigancho 15427, Perú",
  logoUrl: "/Logo/logo-lomas-grill.png",
  phone: "995881303/953034562",
  currency: "S/",
  lowStockThreshold: 5,
  ...
  whatsappCustomFooter: "Por favor confirmar el pedido a los números de delivery: 995881303 / 953034562. ¡Muchas gracias!",
  whatsappIncludeAddress: true,
  whatsappIncludePayment: true,
  whatsappIncludeNotes: true,
  paymentDetails: {
    yape: "995881303 / 953034562",
    yapeHolder: "Las Lomas Grill",
    yapeActive: true,
    yapeImage: "",
    plin: "995881303 / 953034562",
...
export const DEFAULT_SETTINGS_PARADERO: Settings = {
  ...
  address: "Jr. Los Tordos 1009, San Juan de Lurigancho 15427, Perú",
  ...
  whatsappOrdersPhone: "51932208729",
  whatsappOrdersPhone2: "",
